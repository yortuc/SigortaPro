...
(function () {
    ...
    angular.module("sgpApp").controller("ProposalTrafikCtrl", ['$scope', '$state', 'sgpApi', 'dataBus', ProposalTrafikCtrl]);

    function ProposalTrafikCtrl($scope, $state, sgpApi, dataBus) {
        ...
        $scope.doTramerQuery = function (data) {
            ...
            var query = {
                ...
                egmVarmi:  "E", //data.egmBilgiDurumu.value ? "E" : "H",
                asbisNoMu: "H", //data.asbisNoMu.value ? "E" : "H",
            ...
            sgpApi.tramerQuery(query).then(function (ret) {
                ...
                // tramer sonuçları ile formu güncelle
                //$scope.policeBaslangicTarihi = ret[4].KeyValueList[0];
        ...
        $scope.doGetProposalQuery = function (kpd) {
            kpd.bransId = 2;
            sgpApi.getTrafikProposal(kpd).then(function (data) {
